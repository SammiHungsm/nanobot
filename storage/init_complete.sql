...
-- ============================================================
-- 【表 9: vanna_training_data Vanna 訓練數據表】
-- 【功能 Purpose】
-- 儲存 Text-to-SQL 訓練數據，用於 Vanna 模型微調
-- 
-- 【設計理念 Design Philosophy】
-- Vanna 是一個 Text-to-SQL 框架，透過訓練數據學習：
-- - 自然語言問題
-- - 對應的 SQL 查詢
-- 此表記錄高品質的問答對，支援：
-- - 質量評分（quality_score）
...
-- 【關鍵欄位 Key Fields】
-- - question: 自然語言問題
-- - sql_query: 對應的 SQL 查詢
-- - table_name: 相關資料表名稱
-- - documentation: 補充文檔說明
-- - quality_score: 質量評分（0.00 - 1.00）
-- - is_verified: 是否已驗證
-- ============================================================
